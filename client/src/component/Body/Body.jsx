    ...
    return (
        <>
            <div>
                ...
                <img src="" alt="FormBot Image" />
            </div>
            <div>
                <h2>Replace your old school forms with
                    chatbots</h2>
                <p>Typebot is a better way to ask for information. It leads to an increase in customer satisfaction and retention and multiply by 3
            ...
            <div>
                <div className='slider-icons'></div>
                <div>
            ...
            <div>
                <h3>Improve conversion and user engagement
                    with FormBots </h3>
